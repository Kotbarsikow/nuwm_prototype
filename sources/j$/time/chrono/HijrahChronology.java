...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    ...
    private void checkCalendarInit() {
        ...
        try {
            ...
            for (int i2 = 1300; i2 < 1600; i2++) {
                int i3 = (i2 * 12) - this.hijrahStartEpochMonth;
                int[] iArr2 = this.hijrahEpochMonthStartDays;
                int i4 = iArr2[i3 + 12] - iArr2[i3];
                this.minYearLength = Math.min(this.minYearLength, i4);
                this.maxYearLength = Math.max(this.maxYearLength, i4);
            }
    ...
    public final ValueRange range(ChronoField chronoField) {
        ...
        if (chronoField instanceof ChronoField) {
            switch (AnonymousClass1.$SwitchMap$java$time$temporal$ChronoField[chronoField.ordinal()]) {
                case 1:
                    return ValueRange.of$1(this.minMonthLength, this.maxMonthLength);
                case 2:
                ...
                case 4:
                case 5:
                    int i = this.hijrahStartEpochMonth;
                    return ValueRange.of(i / 12, (((this.hijrahEpochMonthStartDays.length - 1) + i) / 12) - 1);
                case 6:
    ...
    final int[] getHijrahDateInfo(int i) {
        checkCalendarInit();
        ...
        int i2 = this.hijrahStartEpochMonth;
        return new int[]{(binarySearch + i2) / 12, ((i2 + binarySearch) % 12) + 1, (i - this.hijrahEpochMonthStartDays[binarySearch]) + 1};
    }

    final long getEpochDay(int i, int i2, int i3) {
        checkCalendarInit();
        if (i2 < 1 || i2 > 12) {
    ...
    final int checkValidYear(long j) {
        int i = this.hijrahStartEpochMonth;
        if (j >= i / 12 && j <= (((this.hijrahEpochMonthStartDays.length - 1) + i) / 12) - 1) {
            return (int) j;
        }
        throw new DateTimeException("Invalid Hijrah year: " + j);
    }

    final int getDayOfYear(int i, int i2) {
        int i3 = (i * 12) - this.hijrahStartEpochMonth;
        int[] iArr = this.hijrahEpochMonthStartDays;
        return iArr[(i2 - 1) + i3] - iArr[i3];
    }

    final int getMonthLength(int i, int i2) {

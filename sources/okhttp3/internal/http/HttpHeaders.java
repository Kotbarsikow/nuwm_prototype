...
public final class HttpHeaders {
    ...
    */
    ...
    public static boolean hasBody(Response response) {
        ...
        return (((code >= 100 && code < 200) || code == 204 || code == 304) && contentLength(response) == -1 && !HttpHeaderValues.CHUNKED.equalsIgnoreCase(response.header("Transfer-Encoding"))) ? false : true;
    }

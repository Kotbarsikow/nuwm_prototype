    ...
    int leftToRightThenRightToLeftProcessing(String str, String str2) {
        ...
        while (i < charArray.length && i <= length2) {
            ...
            if (substring.equals(substring3)) {
                charArray[i] = SpanChipTokenizer.AUTOCORRECT_SEPARATOR;
                charArray2[i] = SpanChipTokenizer.AUTOCORRECT_SEPARATOR;
            }
            if (substring2.equals(substring4)) {
                charArray[i3] = SpanChipTokenizer.AUTOCORRECT_SEPARATOR;
                charArray2[i4] = SpanChipTokenizer.AUTOCORRECT_SEPARATOR;
            }
            i = i2;
        }

...
public class Base64 {
    ...
    public final int encodeIntoByteArray(byte[] source, byte[] r3, int destinationOffset, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(r3, "destination");
        return encodeIntoByteArrayImpl$kotlin_stdlib(source, r3, destinationOffset, startIndex, endIndex);
    }
    ...
    public final <A extends Appendable> A encodeToAppendable(byte[] source, A r3, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(r3, "destination");
        r3.append(new String(encodeToByteArrayImpl$kotlin_stdlib(source, startIndex, endIndex), Charsets.ISO_8859_1));
        return r3;
    }
    ...
    public final int decodeIntoByteArray(byte[] source, byte[] r4, int destinationOffset, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(r4, "destination");
        checkSourceBounds$kotlin_stdlib(source.length, startIndex, endIndex);
        checkDestinationBounds(r4.length, destinationOffset, decodeSize(source, startIndex, endIndex));
        return decodeImpl(source, r4, destinationOffset, startIndex, endIndex);
    }
    ...
    public final int decodeIntoByteArray(CharSequence source, byte[] r10, int destinationOffset, int startIndex, int endIndex) {
        byte[] charsToBytesImpl$kotlin_stdlib;
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(r10, "destination");
        if (source instanceof String) {
            checkSourceBounds$kotlin_stdlib(source.length(), startIndex, endIndex);
            String substring = ((String) source).substring(startIndex, endIndex);
            Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        ...
        return decodeIntoByteArray$default(this, charsToBytesImpl$kotlin_stdlib, r10, destinationOffset, 0, 0, 24, (Object) null);
    }
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] r19, int destinationOffset, int startIndex, int endIndex) {
        int i = startIndex;
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(r19, "destination");
        checkSourceBounds$kotlin_stdlib(source.length, i, endIndex);
        checkDestinationBounds(r19.length, destinationOffset, encodeSize(endIndex - i));
        ...
        while (i + 2 < endIndex) {
            ...
            for (int i4 = 0; i4 < min; i4++) {
                ...
                r19[i3] = bArr[i8 >>> 18];
                r19[i3 + 1] = bArr[(i8 >>> 12) & 63];
                int i9 = i3 + 3;
                r19[i3 + 2] = bArr[(i8 >>> 6) & 63];
                i3 += 4;
                r19[i9] = bArr[i8 & 63];
            }
        ...
        if (i11 == 1) {
            ...
            r19[i3] = bArr[i16 >>> 12];
            r19[i3 + 1] = bArr[(i16 >>> 6) & 63];
            int i17 = i3 + 3;
            r19[i3 + 2] = bArr[i16 & 63];
            i3 += 4;
            r19[i17] = padSymbol;
        }
        if (i == endIndex) {

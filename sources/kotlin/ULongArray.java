...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m497containsVKZWuLQ(((ULong) obj).getData());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl */
    public static long[] m483constructorimpl(int i) {
        return m484constructorimpl(new long[i]);
    }

    /* renamed from: get-s-VKNKU */
    public static final long m489getsVKNKU(long[] jArr, int i) {
        return ULong.m429constructorimpl(jArr[i]);
    }

    /* renamed from: set-k8EXiF4 */
    public static final void m494setk8EXiF4(long[] jArr, int i, long j) {
        jArr[i] = j;
    }

    /* renamed from: getSize-impl */
    public static int m490getSizeimpl(long[] jArr) {
        return jArr.length;
    }
    ...
    public static java.util.Iterator<ULong> m493iteratorimpl(long[] jArr) {
    ...
    public boolean m497containsVKZWuLQ(long j) {
        return m485containsVKZWuLQ(this.storage, j);
    }

    /* renamed from: contains-VKZWuLQ */
    public static boolean m485containsVKZWuLQ(long[] jArr, long j) {
    ...
    public static boolean m486containsAllimpl(long[] jArr, Collection<ULong> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m492isEmptyimpl(long[] jArr) {

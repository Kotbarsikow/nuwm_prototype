...
public final class DurationKt {
    ...
    private static final long m1707timesmvk6XK0(int i, long j) {
        return Duration.m1618timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1706timeskIfJnKk(double d, long j) {
        return Duration.m1617timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1683getZEROUwyO8pc = Duration.INSTANCE.m1683getZEROUwyO8pc();
        ...
        if (str2.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str2.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z7;
                        long m1616plusLRDsOJo = Duration.m1616plusLRDsOJo(m1683getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1683getZEROUwyO8pc = Duration.m1616plusLRDsOJo(m1616plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        m1683getZEROUwyO8pc = Duration.m1616plusLRDsOJo(m1683getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1683getZEROUwyO8pc = Duration.INSTANCE.m1681getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1616plusLRDsOJo2 = Duration.m1616plusLRDsOJo(m1683getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1683getZEROUwyO8pc = Duration.m1616plusLRDsOJo(m1616plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1683getZEROUwyO8pc = Duration.m1616plusLRDsOJo(m1683getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1633unaryMinusUwyO8pc(m1683getZEROUwyO8pc) : m1683getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1580constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1580constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1580constructorimpl((j << 1) + i);
    }

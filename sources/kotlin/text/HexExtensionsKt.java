...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m475toStringimpl(ULong.m429constructorimpl(j))));
    }
    ...
    private static final void checkHexLength(String str, int i, int i2, int i3, boolean z) {
        ...
        String substring = str.substring(i, i2);
        Intrinsics.checkNotNullExpressionValue(substring, "this as java.lang.String…ing(startIndex, endIndex)");
        throw new NumberFormatException("Expected " + str2 + SpanChipTokenizer.AUTOCORRECT_SEPARATOR + i3 + " hexadecimal digits at index " + i + ", but was " + substring + " of length " + i4);
    }

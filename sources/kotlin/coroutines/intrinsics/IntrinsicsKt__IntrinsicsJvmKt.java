    ...
    private static final <T> Continuation<T> createSimpleCoroutineForSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> continuation) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            return new RestrictedContinuationImpl(continuation) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createSimpleCoroutineForSuspendFunction$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                IntrinsicsKt__IntrinsicsJvmKt$createSimpleCoroutineForSuspendFunction$1(Continuation<? super T> continuation2) {
                    super(continuation2);
                    Intrinsics.checkNotNull(continuation2, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
                }
        ...
        return new ContinuationImpl(continuation2, context) { // from class: kotlin.coroutines.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$createSimpleCoroutineForSuspendFunction$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            IntrinsicsKt__IntrinsicsJvmKt$createSimpleCoroutineForSuspendFunction$2(Continuation<? super T> continuation2, CoroutineContext context2) {
                super(continuation2, context2);
                Intrinsics.checkNotNull(continuation2, "null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            }

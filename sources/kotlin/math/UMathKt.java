...
public final class UMathKt {
    ...
    private static final int m1466minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1448minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m1467mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m1456minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m1464maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m1436maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m1465maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m1444maxOfeb3DHEI(j, j2);
    }
}

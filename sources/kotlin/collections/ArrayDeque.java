...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    public void add(int r8, E element) {
        AbstractList.INSTANCE.checkPositionIndex$kotlin_stdlib(r8, size());
        if (r8 == size()) {
            addLast(element);
            return;
        }
    ...
    public boolean addAll(int r9, Collection<? extends E> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        AbstractList.INSTANCE.checkPositionIndex$kotlin_stdlib(r9, size());
        if (elements.isEmpty()) {
            return false;
        }
        if (r9 == size()) {
    ...
    @Override // java.util.AbstractList, java.util.List
    public E get(int r3) {
        AbstractList.INSTANCE.checkElementIndex$kotlin_stdlib(r3, size());
        return (E) this.elementData[positiveMod(this.head + r3)];
    }

    @Override // kotlin.collections.AbstractMutableList, java.util.AbstractList, java.util.List
    public E set(int r3, E element) {
        AbstractList.INSTANCE.checkElementIndex$kotlin_stdlib(r3, size());
    ...
    public E removeAt(int r9) {
        AbstractList.INSTANCE.checkElementIndex$kotlin_stdlib(r9, size());

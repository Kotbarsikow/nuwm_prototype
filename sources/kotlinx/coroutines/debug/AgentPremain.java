...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m254constructorimpl = Result.m254constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m254constructorimpl = Result.m254constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m260isFailureimpl(m254constructorimpl) ? null : m254constructorimpl);

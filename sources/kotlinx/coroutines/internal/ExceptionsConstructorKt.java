...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m254constructorimpl = Result.m254constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        while (true) {
            ...
            if (length2 == 0) {
                pair = TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$4
                    ...
                    ExceptionsConstructorKt$createConstructor$1$4(Constructor<?> constructor2) {
                        super(1);
                        r1 = constructor2;
                    }
                    ...
                    public final Throwable invoke(Throwable th) {
                        Object newInstance = r1.newInstance(null);
                ...
                if (Intrinsics.areEqual(cls2, String.class)) {
                    pair = TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$2
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        ExceptionsConstructorKt$createConstructor$1$2(Constructor<?> constructor2) {
                            super(1);
                            r1 = constructor2;
                        }
                        ...
                        @Override // kotlin.jvm.functions.Function1
                        public final Throwable invoke(Throwable th) {
                            Object newInstance = r1.newInstance(th.getMessage());
                            Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type kotlin.Throwable");
                            Throwable th2 = (Throwable) newInstance;
                            th2.initCause(th);
                            return th2;
                    ...
                    pair = TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$3
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        ExceptionsConstructorKt$createConstructor$1$3(Constructor<?> constructor2) {
                            super(1);
                            r1 = constructor2;
                        }
                        ...
                        @Override // kotlin.jvm.functions.Function1
                        public final Throwable invoke(Throwable th) {
                            Object newInstance = r1.newInstance(th);
                            Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type kotlin.Throwable");
                ...
                if (Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                    pair = TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$1
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        ExceptionsConstructorKt$createConstructor$1$1(Constructor<?> constructor2) {
                            super(1);
                            r1 = constructor2;
                        }
                        ...
                        @Override // kotlin.jvm.functions.Function1
                        public final Throwable invoke(Throwable th) {
                            Object newInstance = r1.newInstance(th.getMessage(), th);
                            Intrinsics.checkNotNull(newInstance, "null cannot be cast to non-null type kotlin.Throwable");
                            return (Throwable) newInstance;
                        }
                    }), 3);
    ...
    private static final Function1<Throwable, Throwable> safeCtor(Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            ExceptionsConstructorKt$safeCtor$1(Function1<? super Throwable, ? extends Throwable> function12) {
                super(1);
                r1 = function12;
            }
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m254constructorimpl = Result.m254constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m254constructorimpl = Result.m254constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m260isFailureimpl(m254constructorimpl) ? null : m254constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m254constructorimpl = Result.m254constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m254constructorimpl = Result.m254constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m260isFailureimpl(m254constructorimpl)) {
            m254constructorimpl = valueOf;
        }
        return ((Number) m254constructorimpl).intValue();
    }

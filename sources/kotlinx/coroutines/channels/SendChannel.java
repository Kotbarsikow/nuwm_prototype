...
public interface SendChannel<E> {
    ...
    Object mo1756trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1756trySendJP2dKIU = sendChannel.mo1756trySendJP2dKIU(e);
            if (ChannelResult.m1776isSuccessimpl(mo1756trySendJP2dKIU)) {
                return true;
            }
            Throwable m1770exceptionOrNullimpl = ChannelResult.m1770exceptionOrNullimpl(mo1756trySendJP2dKIU);

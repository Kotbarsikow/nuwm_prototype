...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo1760receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m1758receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public BufferedChannel(int i, Function1<? super E, Unit> function1) {
        ...
        if (i >= 0) {
            ...
            this.onUndeliveredElementReceiveCancellationConstructor = function1 != 0 ? new Function3<SelectInstance<?>, Object, Object, Function1<? super Throwable, ? extends Unit>>(this) { // from class: kotlinx.coroutines.channels.BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$1$1
                ...
                BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$1$1(BufferedChannel<E> this) {
                    super(3);
                    this.this$0 = this;
                }
                ...
                static final class AnonymousClass1 extends Lambda implements Function1<Throwable, Unit> {
                    ...
                    public final void invoke2(Throwable th) {
                        if (r1 != BufferedChannelKt.getCHANNEL_CLOSED()) {
                            OnUndeliveredElementKt.callUndeliveredElement(r2.onUndeliveredElement, r1, r3.getContext());
                        }
                    }
                }
                ...
                public final Function1<Throwable, Unit> invoke(SelectInstance<?> selectInstance, Object obj, Object obj2) {
                    return new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.channels.BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$1$1.1
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        AnonymousClass1(Object obj22, BufferedChannel<E> bufferedChannel, SelectInstance<?> selectInstance2) {
                            super(1);
                            r1 = obj22;
                            r2 = bufferedChannel;
                            r3 = selectInstance2;
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(sendException)));
    }

    /* JADX WARN: Code restructure failed: missing block: B:51:0x00bd, code lost:
    
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m1781successJP2dKIU(kotlin.Unit.INSTANCE);
     */
    @Override // kotlinx.coroutines.channels.SendChannel
    ...
    */
    public java.lang.Object mo1756trySendJP2dKIU(E r15) {
        /*
            r14 = this;
            ...
            java.lang.Object r15 = r15.m1780failurePtdJZtk()
            return r15
        L13:
        ...
        L90:
            ...
            java.lang.Object r15 = r15.m1779closedJP2dKIU(r0)
            goto Lbd
        L9b:
        ...
        Lb5:
            ...
            java.lang.Object r15 = r15.m1781successJP2dKIU(r0)
        Lbd:
            return r15
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.mo1756trySendJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    private static final class SendBroadcast implements Waiter {
        ...
        public void invokeOnCancellation(Segment<?> segment, int r3) {
            this.$$delegate_0.invokeOnCancellation(segment, r3);
        }
    ...
    public static /* synthetic */ Object sendImpl$default(BufferedChannel bufferedChannel, Object obj, Object obj2, Function0 function0, Function2 function2, Function0 function02, Function4 function4, int i, Object obj3) {
        ...
        Function4 function42 = (i & 32) != 0 ? BufferedChannel$sendImpl$1.INSTANCE : function4;
    ...
    private final void sendImplOnNoWaiter(ChannelSegment<E> segment, int r21, E element, long s, Waiter waiter, Function0<Unit> onRendezvousOrBuffered, Function0<Unit> onClosed) {
        ChannelSegment channelSegment;
        Waiter waiter2 = waiter;
        int updateCellSend = updateCellSend(segment, r21, element, s, waiter, false);
        if (updateCellSend == 0) {
            segment.cleanPrev();
        ...
        if (updateCellSend == 2) {
            prepareSenderForSuspension(waiter2, segment, r21);
            return;
        }
        if (updateCellSend == 4) {
    ...
    public final int updateCellSend(ChannelSegment<E> segment, int r5, E element, long s, Object waiter, boolean closed) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        segment.storeElement$kotlinx_coroutines_core(r5, element);
        if (closed) {
            return updateCellSendSlow(segment, r5, element, s, waiter, closed);
        }
        Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r5);
        if (state$kotlinx_coroutines_core == null) {
            if (bufferOrRendezvousSend(s)) {
                if (segment.casState$kotlinx_coroutines_core(r5, null, BufferedChannelKt.BUFFERED)) {
                    return 1;
                }
            } else {
                if (waiter == null) {
                ...
                if (segment.casState$kotlinx_coroutines_core(r5, null, waiter)) {
                    return 2;
                }
            }
        } else if (state$kotlinx_coroutines_core instanceof Waiter) {
            segment.cleanElement$kotlinx_coroutines_core(r5);
            if (tryResumeReceiver(state$kotlinx_coroutines_core, element)) {
                symbol3 = BufferedChannelKt.DONE_RCV;
                segment.setState$kotlinx_coroutines_core(r5, symbol3);
                onReceiveDequeued();
                return 0;
            }
            symbol = BufferedChannelKt.INTERRUPTED_RCV;
            Object andSetState$kotlinx_coroutines_core = segment.getAndSetState$kotlinx_coroutines_core(r5, symbol);
            symbol2 = BufferedChannelKt.INTERRUPTED_RCV;
            if (andSetState$kotlinx_coroutines_core != symbol2) {
                segment.onCancelledRequest(r5, true);
            }
            return 5;
        }
        return updateCellSendSlow(segment, r5, element, s, waiter, closed);
    ...
    private final int updateCellSendSlow(ChannelSegment<E> segment, int r7, E element, long s, Object waiter, boolean closed) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        Symbol symbol4;
        ...
        Symbol symbol7;
        while (true) {
            Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r7);
            if (state$kotlinx_coroutines_core != null) {
                ...
                if (state$kotlinx_coroutines_core != symbol2) {
                    ...
                    if (state$kotlinx_coroutines_core != symbol3) {
                        ...
                        if (state$kotlinx_coroutines_core == symbol4) {
                            segment.cleanElement$kotlinx_coroutines_core(r7);
                            return 5;
                        }
                        ...
                        if (tryResumeReceiver(state$kotlinx_coroutines_core, element)) {
                            ...
                            segment.setState$kotlinx_coroutines_core(r7, symbol7);
                            onReceiveDequeued();
                            return 0;
                        }
                        symbol5 = BufferedChannelKt.INTERRUPTED_RCV;
                        Object andSetState$kotlinx_coroutines_core = segment.getAndSetState$kotlinx_coroutines_core(r7, symbol5);
                        symbol6 = BufferedChannelKt.INTERRUPTED_RCV;
                        if (andSetState$kotlinx_coroutines_core != symbol6) {
                            segment.onCancelledRequest(r7, true);
                        }
                        return 5;
                    }
                    segment.cleanElement$kotlinx_coroutines_core(r7);
                ...
                if (segment.casState$kotlinx_coroutines_core(r7, state$kotlinx_coroutines_core, BufferedChannelKt.BUFFERED)) {
                    return 1;
                }
            } else if (!bufferOrRendezvousSend(s) || closed) {
                if (closed) {
                    symbol = BufferedChannelKt.INTERRUPTED_SEND;
                    if (segment.casState$kotlinx_coroutines_core(r7, null, symbol)) {
                        segment.onCancelledRequest(r7, false);
                        return 4;
                    }
                } else {
                    if (waiter == null) {
                    ...
                    if (segment.casState$kotlinx_coroutines_core(r7, null, waiter)) {
                        return 2;
                    }
                }
            } else if (segment.casState$kotlinx_coroutines_core(r7, null, BufferedChannelKt.BUFFERED)) {
                return 1;
            }
        }
    }
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult m1766boximpl = ChannelResult.m1766boximpl(ChannelResult.INSTANCE.m1781successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            tryResume02 = BufferedChannelKt.tryResume0(cancellableContinuationImpl, m1766boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
            return tryResume02;
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    static /* synthetic */ <E> java.lang.Object m1758receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r13, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r14) {
        /*
        ...
        L47:
            ...
            java.lang.Object r13 = r14.m1779closedJP2dKIU(r13)
            goto Lb4
        L58:
        ...
        L9a:
            ...
            r1 = r13
            r2 = r14
            java.lang.Object r13 = r1.m1759receiveCatchingOnNoWaiterSuspendGKJJFZk(r2, r3, r4, r6)
            if (r13 != r0) goto Lb4
            return r0
        Lab:
            r14.cleanPrev()
            kotlinx.coroutines.channels.ChannelResult$Companion r13 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r13 = r13.m1781successJP2dKIU(r1)
        Lb4:
            return r13
        Lb5:
            java.lang.IllegalStateException r13 = new java.lang.IllegalStateException
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1758receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m1759receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r17, int r18, long r19, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r21) {
        /*
            Method dump skipped, instructions count: 363
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m1759receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m254constructorimpl(ChannelResult.m1766boximpl(ChannelResult.INSTANCE.m1779closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public Object mo1761tryReceivePtdJZtk() {
        Object obj;
        ChannelSegment channelSegment;
        Symbol symbol;
        Symbol symbol2;
        ...
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m1779closedJP2dKIU(getCloseCause());
        }
            ...
            while (!isClosedForReceive()) {
                ...
                if (updateCellReceive != symbol) {
                    ...
                    if (updateCellReceive != symbol2) {
                        ...
                        channelSegment.cleanPrev();
                        return ChannelResult.INSTANCE.m1781successJP2dKIU(updateCellReceive);
                    }
                    ...
                    channelSegment.onSlotCleaned();
                    return ChannelResult.INSTANCE.m1780failurePtdJZtk();
                }
            }
            return ChannelResult.INSTANCE.m1779closedJP2dKIU(getCloseCause());
        }
    ...
    private final void receiveImplOnNoWaiter(ChannelSegment<E> segment, int r8, long r, Waiter waiter, Function1<? super E, Unit> onElementRetrieved, Function0<Unit> onClosed) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        Symbol symbol4;
        Symbol symbol5;
        Symbol symbol6 = (Object) updateCellReceive(segment, r8, r, waiter);
        symbol = BufferedChannelKt.SUSPEND;
        if (symbol6 != symbol) {
            symbol2 = BufferedChannelKt.FAILED;
            if (symbol6 != symbol2) {
        ...
        prepareReceiverForSuspension(waiter, segment, r8);
    }

    public final Object updateCellReceive(ChannelSegment<E> segment, int r7, long r, Object waiter) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r7);
        if (state$kotlinx_coroutines_core == null) {
            if (r >= (sendersAndCloseStatus$FU.get(this) & 1152921504606846975L)) {
                ...
                if (segment.casState$kotlinx_coroutines_core(r7, state$kotlinx_coroutines_core, waiter)) {
                    expandBuffer();
            ...
            if (segment.casState$kotlinx_coroutines_core(r7, state$kotlinx_coroutines_core, symbol)) {
                expandBuffer();
                return segment.retrieveElement$kotlinx_coroutines_core(r7);
            }
        }
        return updateCellReceiveSlow(segment, r7, r, waiter);
    }

    private final Object updateCellReceiveSlow(ChannelSegment<E> segment, int r7, long r, Object waiter) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        Symbol symbol4;
            ...
            if (state$kotlinx_coroutines_core != null) {
                ...
                if (state$kotlinx_coroutines_core != symbol5) {
                    if (state$kotlinx_coroutines_core == BufferedChannelKt.BUFFERED) {
                        ...
                        if (segment.casState$kotlinx_coroutines_core(r7, state$kotlinx_coroutines_core, symbol6)) {
                            expandBuffer();
                            return segment.retrieveElement$kotlinx_coroutines_core(r7);
                        }
                    } else {
                        ...
                        if (state$kotlinx_coroutines_core != BufferedChannelKt.getCHANNEL_CLOSED()) {
                            ...
                            if (state$kotlinx_coroutines_core != symbol12) {
                                ...
                                if (segment.casState$kotlinx_coroutines_core(r7, state$kotlinx_coroutines_core, symbol13)) {
                                    boolean z = state$kotlinx_coroutines_core instanceof WaiterEB;
                                    if (z) {
                                        state$kotlinx_coroutines_core = ((WaiterEB) state$kotlinx_coroutines_core).waiter;
                                    }
                                    if (tryResumeSender(state$kotlinx_coroutines_core, segment, r7)) {
                                        symbol16 = BufferedChannelKt.DONE_RCV;
                                        segment.setState$kotlinx_coroutines_core(r7, symbol16);
                                        expandBuffer();
                                        return segment.retrieveElement$kotlinx_coroutines_core(r7);
                                    }
                                    symbol14 = BufferedChannelKt.INTERRUPTED_SEND;
                                    segment.setState$kotlinx_coroutines_core(r7, symbol14);
                                    segment.onCancelledRequest(r7, false);
                                    if (z) {
                                        expandBuffer();
                                    }
    ...
    private final boolean updateCellExpandBuffer(ChannelSegment<E> segment, int r6, long b) {
        Symbol symbol;
        Symbol symbol2;
        Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r6);
        if ((state$kotlinx_coroutines_core instanceof Waiter) && b >= receivers$FU.get(this)) {
            symbol = BufferedChannelKt.RESUMING_BY_EB;
            if (segment.casState$kotlinx_coroutines_core(r6, state$kotlinx_coroutines_core, symbol)) {
                if (!tryResumeSender(state$kotlinx_coroutines_core, segment, r6)) {
                    symbol2 = BufferedChannelKt.INTERRUPTED_SEND;
                    segment.setState$kotlinx_coroutines_core(r6, symbol2);
                    segment.onCancelledRequest(r6, false);
                    return false;
                }
                segment.setState$kotlinx_coroutines_core(r6, BufferedChannelKt.BUFFERED);
                return true;
            }
        }
        return updateCellExpandBufferSlow(segment, r6, b);
    }

    private final boolean updateCellExpandBufferSlow(ChannelSegment<E> segment, int r8, long b) {
        Symbol symbol;
        Symbol symbol2;
        Symbol symbol3;
        Symbol symbol4;
        ...
        Symbol symbol8;
        while (true) {
            Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r8);
            if (!(state$kotlinx_coroutines_core instanceof Waiter)) {
                symbol3 = BufferedChannelKt.INTERRUPTED_SEND;
                if (state$kotlinx_coroutines_core != symbol3) {
                    if (state$kotlinx_coroutines_core == null) {
                        symbol4 = BufferedChannelKt.IN_BUFFER;
                        if (segment.casState$kotlinx_coroutines_core(r8, state$kotlinx_coroutines_core, symbol4)) {
                            return true;
                        }
                    } else if (state$kotlinx_coroutines_core != BufferedChannelKt.BUFFERED) {
                ...
                symbol = BufferedChannelKt.RESUMING_BY_EB;
                if (segment.casState$kotlinx_coroutines_core(r8, state$kotlinx_coroutines_core, symbol)) {
                    if (!tryResumeSender(state$kotlinx_coroutines_core, segment, r8)) {
                        symbol2 = BufferedChannelKt.INTERRUPTED_SEND;
                        segment.setState$kotlinx_coroutines_core(r8, symbol2);
                        segment.onCancelledRequest(r8, false);
                        return false;
                    }
                    segment.setState$kotlinx_coroutines_core(r8, BufferedChannelKt.BUFFERED);
                    return true;
                }
            } else if (segment.casState$kotlinx_coroutines_core(r8, state$kotlinx_coroutines_core, new WaiterEB((Waiter) state$kotlinx_coroutines_core))) {
                return true;
            }
        }
    }
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m1766boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m1779closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m1781successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m254constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    */
    private final void removeUnprocessedElements(kotlinx.coroutines.channels.ChannelSegment<E> r13) {
        /*
            ...
            r1 = 0
            r2 = 1
            java.lang.Object r3 = kotlinx.coroutines.internal.InlineList.m1803constructorimpl$default(r1, r2, r1)
        L8:
        ...
        L84:
            ...
            kotlinx.coroutines.internal.UndeliveredElementException r1 = kotlinx.coroutines.internal.OnUndeliveredElementKt.callUndeliveredElementCatchingException(r0, r5, r1)
        L98:
            java.lang.Object r3 = kotlinx.coroutines.internal.InlineList.m1808plusFjFbRPM(r3, r9)
            r13.cleanElement$kotlinx_coroutines_core(r4)
            r13.onSlotCleaned()
            goto Lb0
        La3:
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Symbol symbol;
        Object m1803constructorimpl$default = InlineList.m1803constructorimpl$default(null, 1, null);
                        ...
                        if (state$kotlinx_coroutines_core != symbol) {
                            if (state$kotlinx_coroutines_core instanceof WaiterEB) {
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m1803constructorimpl$default = InlineList.m1808plusFjFbRPM(m1803constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                                ...
                                if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                                    m1803constructorimpl$default = InlineList.m1808plusFjFbRPM(m1803constructorimpl$default, state$kotlinx_coroutines_core);
                                    lastSegment.onCancelledRequest(i, true);
                                    break;
                                }
                            }
        ...
        if (m1803constructorimpl$default != null) {
            if (!(m1803constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) m1803constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(m1803constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) m1803constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m254constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m254constructorimpl(ChannelResult.m1766boximpl(ChannelResult.INSTANCE.m1779closedJP2dKIU(getCloseCause()))));
    ...
    private final boolean isCellNonEmpty(ChannelSegment<E> segment, int r6, long globalIndex) {
        ...
        Symbol symbol7;
        do {
            state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(r6);
            if (state$kotlinx_coroutines_core != null) {
                symbol2 = BufferedChannelKt.IN_BUFFER;
                if (state$kotlinx_coroutines_core != symbol2) {
                    if (state$kotlinx_coroutines_core == BufferedChannelKt.BUFFERED) {
            ...
            symbol = BufferedChannelKt.POISONED;
        } while (!segment.casState$kotlinx_coroutines_core(r6, state$kotlinx_coroutines_core, symbol));
        expandBuffer();
        return false;
    }
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m1820isClosedimpl(findSegmentInternal)) {
                Segment m1818getSegmentimpl = SegmentOrClosed.m1818getSegmentimpl(findSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= m1818getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!m1818getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, m1818getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (m1818getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        m1818getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m1818getSegmentimpl(findSegmentInternal);
    ...
    */
    ...
    public final String toStringDebug$kotlinx_coroutines_core() {
        ...
        do {
            ...
            sb4.append("=[");
            sb4.append(channelSegment3.isRemoved() ? Constraint.ANY_ROLE : "");
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(undeliveredElementException)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m254constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:48:0x00c3, code lost:
        ...
        r11.resumeWith(kotlin.Result.m254constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences

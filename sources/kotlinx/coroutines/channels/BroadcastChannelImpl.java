...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        try {
            ...
            symbol = BroadcastChannelKt.NO_ELEMENT;
            if (obj2 != symbol) {
                subscriberConflated.mo1756trySendJP2dKIU(getValue());
            }
    ...
    */
    ...
    public Object mo1756trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo1756trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo1756trySendJP2dKIU(element);
            }

...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m1784trySendImplMj0NB7M = conflatedBufferedChannel.m1784trySendImplMj0NB7M(e, true);
        if (m1784trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1770exceptionOrNullimpl(m1784trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m1784trySendImplMj0NB7M = conflatedBufferedChannel.m1784trySendImplMj0NB7M(e, true);
        if (!(m1784trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo1756trySendJP2dKIU(E element) {
        return m1784trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1784trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1782trySendDropLatestMj0NB7M(element, isSendOp) : m1783trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1782trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo1756trySendJP2dKIU = super.mo1756trySendJP2dKIU(element);
        if (ChannelResult.m1776isSuccessimpl(mo1756trySendJP2dKIU) || ChannelResult.m1774isClosedimpl(mo1756trySendJP2dKIU)) {
            return mo1756trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m1781successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m1783trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m1779closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo1756trySendJP2dKIU = mo1756trySendJP2dKIU(element);
        if (!(mo1756trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo1756trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1770exceptionOrNullimpl(mo1756trySendJP2dKIU);

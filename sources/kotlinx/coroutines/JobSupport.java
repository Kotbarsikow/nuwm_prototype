...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final boolean addLastAtomic(Object expect, NodeList list, JobNode node) {
        ...
        JobSupport$addLastAtomic$$inlined$addLastIf$1 jobSupport$addLastAtomic$$inlined$addLastIf$1 = new LockFreeLinkedListNode.CondAddOp(jobNode) { // from class: kotlinx.coroutines.JobSupport$addLastAtomic$$inlined$addLastIf$1
            ...
            public JobSupport$addLastAtomic$$inlined$addLastIf$1(LockFreeLinkedListNode jobNode2, JobSupport this, Object expect2) {
                super(jobNode2);
                r2 = this;
                r3 = expect2;
            }
            ...
            public Object prepare(LockFreeLinkedListNode affected) {
                if (r2.getState$kotlinx_coroutines_core() == r3) {
                    return null;
                }
        ...
        do {
            tryCondAddNext = nodeList.getPrevNode().tryCondAddNext(jobNode2, nodeList, jobSupport$addLastAtomic$$inlined$addLastIf$1);
            if (tryCondAddNext == 1) {
                return true;
            }

...
import com.m_myr.nuwm.nuwmschedule.ui.view.VerticalTextView;

/* loaded from: classes2.dex */
public final class IdCardLayoutNew0299Binding implements ViewBinding {
    ...
    public final VerticalTextView textView3;
    public final TextView textView4;
    public final TextView verificationText;

    private IdCardLayoutNew0299Binding(ConstraintLayout rootView, ConstraintLayout backgroundBottom, ConstraintLayout backgroundPhoto, CardView cardView, ImageView code, TextView codetext, TextView department, FloatingActionButton fab, ImageView imageView3, AppCompatImageView imvLogoOnAuthScreen, LinearLayout linearLayout2, RelativeLayout linearLayout4, MaterialButton loadPhoto, TextView name, ImageView personPhoto, RelativeLayout photo, TextView post, ProgressBar progressBar, RelativeLayout relativeLayout2, TextView textView2, VerticalTextView textView3, TextView textView4, TextView verificationText) {
    ...
    public static IdCardLayoutNew0299Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static IdCardLayoutNew0299Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.id_card_layout_new_0_299, parent, false);
        if (attachToParent) {
    ...
    public static IdCardLayoutNew0299Binding bind(View rootView) {
                                    ...
                                    if (imageView2 != null) {
                                        ...
                                        if (appCompatImageView != null) {
                                            ...
                                            if (linearLayout != null) {
                                                ...
                                                RelativeLayout relativeLayout = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.linearLayout4);
                                                if (relativeLayout != null) {
                                                    ...
                                                    if (materialButton != null) {
                                                        ...
                                                        if (textView3 != null) {
                                                            i = R.id.person_photo;
                                                            ImageView imageView3 = (ImageView) ViewBindings.findChildViewById(rootView, R.id.person_photo);
                                                            if (imageView3 != null) {
                                                                i = R.id.photo;
                                                                RelativeLayout relativeLayout2 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.photo);
                                                                if (relativeLayout2 != null) {
                                                                    ...
                                                                    if (textView4 != null) {
                                                                        ...
                                                                        if (progressBar != null) {
                                                                            ...
                                                                            RelativeLayout relativeLayout3 = (RelativeLayout) ViewBindings.findChildViewById(rootView, R.id.relativeLayout2);
                                                                            if (relativeLayout3 != null) {
                                                                                i = R.id.textView2;
                                                                                TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.textView2);
                                                                                if (textView5 != null) {
                                                                                    i = R.id.textView3;
                                                                                    VerticalTextView verticalTextView = (VerticalTextView) ViewBindings.findChildViewById(rootView, R.id.textView3);
                                                                                    if (verticalTextView != null) {
                                                                                        i = R.id.textView4;
                                                                                        TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.textView4);
                                                                                        if (textView6 != null) {
                                                                                            i = R.id.verificationText;
                                                                                            TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.verificationText);
                                                                                            if (textView7 != null) {
                                                                                                return new IdCardLayoutNew0299Binding((ConstraintLayout) rootView, constraintLayout, constraintLayout2, cardView, imageView, textView, textView2, floatingActionButton, imageView2, appCompatImageView, linearLayout, relativeLayout, materialButton, textView3, imageView3, relativeLayout2, textView4, progressBar, relativeLayout3, textView5, verticalTextView, textView6, textView7);
                                                                                            }
                                                                                        }
                                                                                    }
                                                                                }

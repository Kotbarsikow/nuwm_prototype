...
public final class IdCardLayout300420Binding implements ViewBinding {
    ...
    public static IdCardLayout300420Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static IdCardLayout300420Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.id_card_layout_300_420, parent, false);
        if (attachToParent) {
    ...
    public static IdCardLayout300420Binding bind(View rootView) {

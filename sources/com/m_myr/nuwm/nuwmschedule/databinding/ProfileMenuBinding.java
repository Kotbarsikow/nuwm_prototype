...
public final class ProfileMenuBinding implements ViewBinding {
    ...
    public static ProfileMenuBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ProfileMenuBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.profile_menu, parent, false);
        if (attachToParent) {
    ...
    public static ProfileMenuBinding bind(View rootView) {
        int i = R.id.about;
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (textView3 != null) {
                                                                        ...
                                                                        if (materialCardView != null) {
                                                                            return new ProfileMenuBinding((LinearLayout) rootView, linearLayout, linearLayout2, linearLayout3, textView, materialButton, imageView, imageView2, linearLayout4, linearLayout5, imageView3, relativeLayout, linearLayout6, toolbar, appCompatTextView, textView2, textView3, materialCardView);
                                                                        }
                                                                    }
                                                                }
                                                            }

...
public final class IdCardLayout420500Binding implements ViewBinding {
    ...
    public static IdCardLayout420500Binding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static IdCardLayout420500Binding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.id_card_layout_420_500, parent, false);
        if (attachToParent) {
    ...
    public static IdCardLayout420500Binding bind(View rootView) {

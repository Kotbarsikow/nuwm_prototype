...
public final class AbitCalendraViewBinding implements ViewBinding {
    ...
    private AbitCalendraViewBinding(LinearLayout rootView, CardView abitCalendarItem1, CardView abitCalendarItem2, CardView abitCalendarItem3, CardView abitCalendarItem4, CardView abitCalendarItem5, CardView abitCalendarItem6, CardView abitCalendarItem7, CardView abitCalendarItem8) {
    ...
    public static AbitCalendraViewBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static AbitCalendraViewBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.abit_calendra_view, parent, false);
        if (attachToParent) {
    ...
    public static AbitCalendraViewBinding bind(View rootView) {
                        ...
                        if (cardView5 != null) {
                            ...
                            if (cardView6 != null) {
                                ...
                                if (cardView7 != null) {
                                    ...
                                    if (cardView8 != null) {
                                        return new AbitCalendraViewBinding((LinearLayout) rootView, cardView, cardView2, cardView3, cardView4, cardView5, cardView6, cardView7, cardView8);
                                    }
                                }
                            }
                        }

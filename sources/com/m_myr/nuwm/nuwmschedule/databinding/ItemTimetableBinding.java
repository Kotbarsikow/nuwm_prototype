...
public final class ItemTimetableBinding implements ViewBinding {
    ...
    private ItemTimetableBinding(LinearLayout rootView, DividerVerticalView divider, TextView strComp, TextView strRoom, TextView strSubject, TextView strTask, TextView strTimeEnd, TextView strTimeStart, TextView strType, View taskIcon, LinearLayout taskLayout) {
    ...
    public static ItemTimetableBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static ItemTimetableBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.item_timetable, parent, false);
        if (attachToParent) {
    ...
    public static ItemTimetableBinding bind(View rootView) {
        int i = R.id.divider;
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (textView3 != null) {
                        ...
                        if (textView4 != null) {
                            i = R.id.str_time_end;
                            TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.str_time_end);
                            if (textView5 != null) {
                                i = R.id.str_time_start;
                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.str_time_start);
                                if (textView6 != null) {
                                    i = R.id.str_type;
                                    TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.str_type);
                                    if (textView7 != null) {
                                        i = R.id.task_icon;
                                        ...
                                        if (findChildViewById != null) {
                                            ...
                                            if (linearLayout != null) {
                                                return new ItemTimetableBinding((LinearLayout) rootView, dividerVerticalView, textView, textView2, textView3, textView4, textView5, textView6, textView7, findChildViewById, linearLayout);
                                            }
                                        }
                                    }
                                }

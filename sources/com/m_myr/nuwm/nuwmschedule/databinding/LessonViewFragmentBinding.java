...
public final class LessonViewFragmentBinding implements ViewBinding {
    ...
    private LessonViewFragmentBinding(LinearLayout rootView, BottomAppBar bottomAppBar, ImageButton cancel, View colorMark, TextInputEditText editNoteView, FloatingActionButton fab, LinearLayout groupLayout, LinearLayout lineTypeName, LinearLayout listDetals, LinearLayout locationLayout, TextView locationName, CoordinatorLayout mainContent, LinearLayout mainFrameLesson, LinearLayout meetLayout, TextView meetLink, LinearLayout noteEdit, RelativeLayout noteLayout, AppCompatTextView noteTextView, LinearLayout noteView, LinearLayout otherLayout, TextView otherName, ImageButton save, TextView staticTeacherField, TextView strSubject, TextView subgroupName, TextView subgroupStatic, LinearLayout teacherLayout, TextView teacherName, TextView timeName, Toolbar toolbar, TextView typeName) {
    ...
    public static LessonViewFragmentBinding inflate(LayoutInflater inflater) {
        return inflate(inflater, null, false);
    }

    public static LessonViewFragmentBinding inflate(LayoutInflater inflater, ViewGroup parent, boolean attachToParent) {
        View inflate = inflater.inflate(R.layout.lesson_view_fragment, parent, false);
        if (attachToParent) {
    ...
    public static LessonViewFragmentBinding bind(View rootView) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (coordinatorLayout != null) {
                                                    ...
                                                    if (linearLayout6 != null) {
                                                        i = R.id.meet_link;
                                                        TextView textView2 = (TextView) ViewBindings.findChildViewById(rootView, R.id.meet_link);
                                                        if (textView2 != null) {
                                                            i = R.id.note_edit;
                                                            LinearLayout linearLayout7 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.note_edit);
                                                            if (linearLayout7 != null) {
                                                                ...
                                                                if (relativeLayout != null) {
                                                                    ...
                                                                    if (appCompatTextView != null) {
                                                                        i = R.id.note_view;
                                                                        LinearLayout linearLayout8 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.note_view);
                                                                        if (linearLayout8 != null) {
                                                                            i = R.id.other_layout;
                                                                            LinearLayout linearLayout9 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.other_layout);
                                                                            if (linearLayout9 != null) {
                                                                                i = R.id.other_name;
                                                                                TextView textView3 = (TextView) ViewBindings.findChildViewById(rootView, R.id.other_name);
                                                                                if (textView3 != null) {
                                                                                    i = R.id.save;
                                                                                    ImageButton imageButton2 = (ImageButton) ViewBindings.findChildViewById(rootView, R.id.save);
                                                                                    if (imageButton2 != null) {
                                                                                        i = R.id.static_teacher_field;
                                                                                        TextView textView4 = (TextView) ViewBindings.findChildViewById(rootView, R.id.static_teacher_field);
                                                                                        if (textView4 != null) {
                                                                                            i = R.id.str_subject;
                                                                                            TextView textView5 = (TextView) ViewBindings.findChildViewById(rootView, R.id.str_subject);
                                                                                            if (textView5 != null) {
                                                                                                i = R.id.subgroup_name;
                                                                                                TextView textView6 = (TextView) ViewBindings.findChildViewById(rootView, R.id.subgroup_name);
                                                                                                if (textView6 != null) {
                                                                                                    i = R.id.subgroup_static;
                                                                                                    TextView textView7 = (TextView) ViewBindings.findChildViewById(rootView, R.id.subgroup_static);
                                                                                                    if (textView7 != null) {
                                                                                                        i = R.id.teacher_layout;
                                                                                                        LinearLayout linearLayout10 = (LinearLayout) ViewBindings.findChildViewById(rootView, R.id.teacher_layout);
                                                                                                        if (linearLayout10 != null) {
                                                                                                            i = R.id.teacher_name;
                                                                                                            TextView textView8 = (TextView) ViewBindings.findChildViewById(rootView, R.id.teacher_name);
                                                                                                            if (textView8 != null) {
                                                                                                                i = R.id.time_name;
                                                                                                                TextView textView9 = (TextView) ViewBindings.findChildViewById(rootView, R.id.time_name);
                                                                                                                if (textView9 != null) {
                                                                                                                    i = R.id.toolbar;
                                                                                                                    Toolbar toolbar = (Toolbar) ViewBindings.findChildViewById(rootView, R.id.toolbar);
                                                                                                                    if (toolbar != null) {
                                                                                                                        i = R.id.type_name;
                                                                                                                        TextView textView10 = (TextView) ViewBindings.findChildViewById(rootView, R.id.type_name);
                                                                                                                        if (textView10 != null) {
                                                                                                                            return new LessonViewFragmentBinding(linearLayout5, bottomAppBar, imageButton, findChildViewById, textInputEditText, floatingActionButton, linearLayout, linearLayout2, linearLayout3, linearLayout4, textView, coordinatorLayout, linearLayout5, linearLayout6, textView2, linearLayout7, relativeLayout, appCompatTextView, linearLayout8, linearLayout9, textView3, imageButton2, textView4, textView5, textView6, textView7, linearLayout10, textView8, textView9, toolbar, textView10);
                                                                                                                        }
                                                                                                                    }
                                                                                                                }
                                                                                                            }

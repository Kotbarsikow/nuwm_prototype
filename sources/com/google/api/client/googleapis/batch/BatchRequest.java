    ...
    public void execute() throws IOException {
        ...
        do {
            ...
            try {
                ...
                BatchUnparsedResponse batchUnparsedResponse = new BatchUnparsedResponse(execute.getContent(), valueOf.length() != 0 ? "--".concat(valueOf) : new String("--"), this.requestInfos, z);

...
public final class zzai implements zzaq {
    ...
    public final Boolean zzd() {
        return Boolean.valueOf((Double.isNaN(this.zza.doubleValue()) || this.zza.doubleValue() == Utils.DOUBLE_EPSILON) ? false : true);
    }
    ...
    public final String zzf() {
        ...
        if (Double.isInfinite(this.zza.doubleValue())) {
            if (this.zza.doubleValue() > Utils.DOUBLE_EPSILON) {
                return "Infinity";
            }
            return "-Infinity";
        }

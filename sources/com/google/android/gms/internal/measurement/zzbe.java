    ...
    public static zzaq zza(String str, zzaf zzafVar, zzh zzhVar, List<zzaq> list) {
        ...
        switch (c) {
            ...
            case 16:
                ...
                if (zza17 < Utils.DOUBLE_EPSILON) {
                    min = Math.max(zza17 + zzb6, Utils.DOUBLE_EPSILON);
                } else {
                    min = Math.min(zza17, zzb6);
                }
                if (list.size() == 2) {
                    double zza18 = zzg.zza(zzhVar.zza(list.get(1)).zze().doubleValue());
                    if (zza18 < Utils.DOUBLE_EPSILON) {
                        zzb6 = Math.max(zzb6 + zza18, Utils.DOUBLE_EPSILON);
                    } else {
            ...
            case 19:
                ...
                if (list.size() > 1) {
                    ...
                    d = zza20 < Utils.DOUBLE_EPSILON ? zzafVar.zzb() + zza20 : zza20;
                }

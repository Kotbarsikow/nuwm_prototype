...
public final class zzba extends zzay {
    ...
    */
    ...
    private static boolean zzb(zzaq zzaqVar, zzaq zzaqVar2) {
        ...
        return (Double.isNaN(doubleValue) || Double.isNaN(doubleValue2) || (doubleValue == Utils.DOUBLE_EPSILON && doubleValue2 == -0.0d) || ((doubleValue == -0.0d && doubleValue2 == Utils.DOUBLE_EPSILON) || Double.compare(doubleValue, doubleValue2) >= 0)) ? false : true;
    }

...
public final class MediaType {
    ...
    private static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(SpanChipTokenizer.AUTOCORRECT_SEPARATOR)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));

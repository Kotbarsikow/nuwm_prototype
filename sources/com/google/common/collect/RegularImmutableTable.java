    ...
    static <R, C, V> RegularImmutableTable<R, C, V> forCells(List<Table.Cell<R, C, V>> list, @CheckForNull Comparator<? super R> comparator, @CheckForNull Comparator<? super C> comparator2) {
        ...
        if (comparator != null || comparator2 != null) {
            Collections.sort(list, new Comparator() { // from class: com.google.common.collect.RegularImmutableTable$$ExternalSyntheticLambda0
                ...
                public /* synthetic */ RegularImmutableTable$$ExternalSyntheticLambda0(Comparator comparator3, Comparator comparator22) {
                    r1 = comparator3;
                    r2 = comparator22;
                }
                ...
                public final int compare(Object obj, Object obj2) {
                    return RegularImmutableTable.lambda$forCells$0(r1, r2, (Table.Cell) obj, (Table.Cell) obj2);
                }
            });
        }

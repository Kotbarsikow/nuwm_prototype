...
public final class Iterators {
    ...
    class AnonymousClass3<I> extends UnmodifiableIterator<I> {
        ...
        public Iterator next() {
            ...
            Iterator it = (Iterator) j$.util.Objects.requireNonNull(r1[this.index]);
            Iterator[] itArr = r1;
            int i = this.index;
            itArr[i] = null;
            this.index = i + 1;
    ...
    private static <T> UnmodifiableIterator<List<T>> partitionImpl(Iterator<T> it, int i, boolean z) {
        ...
        return new UnmodifiableIterator<List<T>>() { // from class: com.google.common.collect.Iterators.4
            ...
            public List<T> next() {
                ...
                return (r3 || i2 == r2) ? unmodifiableList : unmodifiableList.subList(0, i2);
            }
        };
    }
    ...
    static class MergingIterator<T> extends UnmodifiableIterator<T> {
        ...
        public MergingIterator(Iterable<? extends Iterator<? extends T>> iterable, Comparator<? super T> comparator) {
            this.queue = new PriorityQueue(2, new Comparator() { // from class: com.google.common.collect.Iterators$MergingIterator$$ExternalSyntheticLambda0
                ...
                public /* synthetic */ Iterators$MergingIterator$$ExternalSyntheticLambda0(Comparator comparator2) {
                    r1 = comparator2;
                }
                ...
                public final int compare(Object obj, Object obj2) {
                    int compare;
                    compare = r1.compare(((PeekingIterator) obj).peek(), ((PeekingIterator) obj2).peek());
                    return compare;
                }
            });

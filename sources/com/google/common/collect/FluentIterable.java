...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    class AnonymousClass2<T> extends FluentIterable<T> {
        ...
        public Iterator<T> iterator() {
            return Iterators.concat(Iterators.transform(r1.iterator(), Iterables.toIterator()));
        }
    }
    ...
    private static <T> FluentIterable<T> concatNoDefensiveCopy(Iterable<? extends T>... iterableArr) {
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.3
            ...
            @Override // java.lang.Iterable
            public Iterator<T> iterator() {
                return Iterators.concat(new AbstractIndexedListIterator<Iterator<? extends T>>(r1.length) { // from class: com.google.common.collect.FluentIterable.3.1

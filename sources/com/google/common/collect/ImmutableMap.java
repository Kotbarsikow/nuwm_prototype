...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable, j$.util.Map {
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        class AnonymousClass1 extends UnmodifiableIterator<Map.Entry<K, ImmutableSet<V>>> {
            ...
            class C00251 extends AbstractMapEntry<K, ImmutableSet<V>> {
                final /* synthetic */ Map.Entry val$backingEntry;

                C00251(AnonymousClass1 anonymousClass1, Map.Entry entry) {
                    r2 = entry;
                }
                ...
                public ImmutableSet<V> getValue() {
                    return ImmutableSet.of(r2.getValue());
                }
            }
            ...
            public Map.Entry<K, ImmutableSet<V>> next() {
                return new AbstractMapEntry<K, ImmutableSet<V>>(this) { // from class: com.google.common.collect.ImmutableMap.MapViewOfValuesAsSingletonSets.1.1
                    ...
                    C00251(AnonymousClass1 this, Map.Entry entry) {
                        r2 = entry;
                    }

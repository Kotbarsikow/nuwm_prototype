...
public final class Maps {
    ...
    class AnonymousClass3<K, V> extends TransformedIterator<K, Map.Entry<K, V>> {
        ...
        Map.Entry<K, V> transform(@ParametricNullness K k) {
            return Maps.immutableEntry(k, r2.apply(k));
        }
    }
    ...
    class AnonymousClass8<K, V> extends UnmodifiableIterator<Map.Entry<K, V>> {
        ...
        public Map.Entry<K, V> next() {
            return Maps.unmodifiableEntry((Map.Entry) r1.next());
        }
    }
    ...
    class AnonymousClass10<V1, V2> implements Function<V1, V2> {
        ...
        public V2 apply(@ParametricNullness V1 v1) {
            return (V2) EntryTransformer.this.transformEntry(r2, v1);
        }
    }
    ...
    static <V2, K, V1> Map.Entry<K, V2> transformEntry(EntryTransformer<? super K, ? super V1, V2> entryTransformer, Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.common.collect.Maps.12
            ...
            @ParametricNullness
            public V2 getValue() {
                return (V2) r2.transformEntry(r1.getKey(), r1.getValue());
            }
        };
    }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            class AnonymousClass1 extends TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>> {
                ...
                class C00261 extends ForwardingMapEntry<K, V> {
                    final /* synthetic */ Map.Entry val$entry;

                    C00261(Map.Entry entry) {
                        r2 = entry;
                    }

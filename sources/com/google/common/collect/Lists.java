...
public final class Lists {
        ...
        public ListIterator<T> listIterator(int i) {
            return new ListIterator<T>() { // from class: com.google.common.collect.Lists.ReverseList.1
                ...
                public T next() {
                    ...
                    return (T) r2.previous();
                }

                @Override // java.util.ListIterator
                public int nextIndex() {
                    return ReverseList.this.reversePosition(r2.nextIndex());
                }
    ...
    static <E> List<E> subListImpl(List<E> list, int i, int i2) {
        ...
        if (list instanceof RandomAccess) {
            anonymousClass2 = new RandomAccessListWrapper<E>(list) { // from class: com.google.common.collect.Lists.1
                private static final long serialVersionUID = 0;
            ...
            anonymousClass2 = new AbstractListWrapper<E>(list2) { // from class: com.google.common.collect.Lists.2
                private static final long serialVersionUID = 0;
        ...
        return anonymousClass2.subList(i, i2);
    }

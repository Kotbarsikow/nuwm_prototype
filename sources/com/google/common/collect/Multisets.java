...
public final class Multisets {
    ...
    public static <E> Multiset<E> union(Multiset<? extends E> multiset, Multiset<? extends E> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.1
            ...
            public boolean contains(@CheckForNull Object obj) {
                return Multiset.this.contains(obj) || r2.contains(obj);
            }

            @Override // com.google.common.collect.AbstractMultiset, java.util.AbstractCollection, java.util.Collection
            public boolean isEmpty() {
                return Multiset.this.isEmpty() && r2.isEmpty();
            }

            @Override // com.google.common.collect.Multiset
            public int count(@CheckForNull Object obj) {
                return Math.max(Multiset.this.count(obj), r2.count(obj));
            }

            @Override // com.google.common.collect.AbstractMultiset
            Set<E> createElementSet() {
                return Sets.union(Multiset.this.elementSet(), r2.elementSet());
            }
            ...
            Iterator<Multiset.Entry<E>> entryIterator() {
                return new AbstractIterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.Multisets.1.1
                    ...
                    C00291(Iterator it, Iterator it2) {
                        r2 = it;
                        r3 = it2;
                    }
                    ...
                    public Multiset.Entry<E> computeNext() {
                        if (r2.hasNext()) {
                            Multiset.Entry entry = (Multiset.Entry) r2.next();
                            Object element = entry.getElement();
                            return Multisets.immutableEntry(element, Math.max(entry.getCount(), r2.count(element)));
                        }
                        while (r3.hasNext()) {
                            Multiset.Entry entry2 = (Multiset.Entry) r3.next();
            ...
            class C00291 extends AbstractIterator<Multiset.Entry<E>> {
                final /* synthetic */ Iterator val$iterator1;
                final /* synthetic */ Iterator val$iterator2;
    ...
    public static <E> Multiset<E> intersection(Multiset<E> multiset, Multiset<?> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.2
            ...
            public int count(@CheckForNull Object obj) {
                ...
                return Math.min(count, r2.count(obj));
            }

            @Override // com.google.common.collect.AbstractMultiset
            Set<E> createElementSet() {
                return Sets.intersection(Multiset.this.elementSet(), r2.elementSet());
            }
                ...
                return new AbstractIterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.Multisets.2.1
                    ...
                    public Multiset.Entry<E> computeNext() {
                        while (r2.hasNext()) {
                            Multiset.Entry entry = (Multiset.Entry) r2.next();
                            Object element = entry.getElement();
                            int min = Math.min(entry.getCount(), r2.count(element));
                            if (min > 0) {
    ...
    public static <E> Multiset<E> sum(Multiset<? extends E> multiset, Multiset<? extends E> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.3
            ...
            public int size() {
                return IntMath.saturatedAdd(Multiset.this.size(), r2.size());
            }

            @Override // com.google.common.collect.Multiset
            public int count(@CheckForNull Object obj) {
                return Multiset.this.count(obj) + r2.count(obj);
            }
                ...
                return new AbstractIterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.Multisets.3.1
                    ...
                    public Multiset.Entry<E> computeNext() {
                        if (r2.hasNext()) {
                            Multiset.Entry entry = (Multiset.Entry) r2.next();
                            Object element = entry.getElement();
                            return Multisets.immutableEntry(element, entry.getCount() + r2.count(element));
                        }
                        while (r3.hasNext()) {
                            Multiset.Entry entry2 = (Multiset.Entry) r3.next();
                            Object element2 = entry2.getElement();
    ...
    public static <E> Multiset<E> difference(Multiset<E> multiset, Multiset<?> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.4
            ...
            public int count(@CheckForNull Object obj) {
                ...
                return Math.max(0, count - r2.count(obj));
            }
            ...
            class AnonymousClass2 extends AbstractIterator<Multiset.Entry<E>> {
                ...
                public Multiset.Entry<E> computeNext() {
                    while (r2.hasNext()) {
                        Multiset.Entry entry = (Multiset.Entry) r2.next();
                        Object element = entry.getElement();
                        int count = entry.getCount() - r2.count(element);
                        if (count > 0) {

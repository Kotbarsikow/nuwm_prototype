    ...
    private static List<StackTraceElement> jlaStackTrace(Throwable th) {
        ...
        return new AbstractList<StackTraceElement>() { // from class: com.google.common.base.Throwables.1
            ...
            public StackTraceElement get(int i) {
                return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod((Method) j$.util.Objects.requireNonNull(Throwables.getStackTraceElementMethod), j$.util.Objects.requireNonNull(Throwables.jla), r1, Integer.valueOf(i));
            }

            @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
            public int size() {
                return ((Integer) Throwables.invokeAccessibleNonThrowingMethod((Method) j$.util.Objects.requireNonNull(Throwables.getStackTraceDepthMethod), j$.util.Objects.requireNonNull(Throwables.jla), r1)).intValue();
            }
        };
    }

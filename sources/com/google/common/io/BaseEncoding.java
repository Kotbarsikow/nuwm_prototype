...
public abstract class BaseEncoding {
    ...
    class AnonymousClass1 extends ByteSink {
        ...
        public OutputStream openStream() throws IOException {
            return BaseEncoding.this.encodingStream(r2.openStream());
        }
    }
    ...
    class AnonymousClass2 extends ByteSource {
        ...
        public InputStream openStream() throws IOException {
            return BaseEncoding.this.decodingStream(r2.openStream());
        }
    }
        ...
        class AnonymousClass1 extends OutputStream {
            ...
            public void write(int i) throws IOException {
                ...
                while (this.bitBufferLength >= StandardBaseEncoding.this.alphabet.bitsPerChar) {
                    r2.write(StandardBaseEncoding.this.alphabet.encode((this.bitBuffer >> (this.bitBufferLength - StandardBaseEncoding.this.alphabet.bitsPerChar)) & StandardBaseEncoding.this.alphabet.mask));
                    this.writtenChars++;
            ...
            public void close() throws IOException {
                if (this.bitBufferLength > 0) {
                    r2.write(StandardBaseEncoding.this.alphabet.encode((this.bitBuffer << (StandardBaseEncoding.this.alphabet.bitsPerChar - this.bitBufferLength)) & StandardBaseEncoding.this.alphabet.mask));
                    this.writtenChars++;
                    if (StandardBaseEncoding.this.paddingChar != null) {
                        while (this.writtenChars % StandardBaseEncoding.this.alphabet.charsPerChunk != 0) {
                            r2.write(StandardBaseEncoding.this.paddingChar.charValue());
                            this.writtenChars++;
                        }
                    }
                }

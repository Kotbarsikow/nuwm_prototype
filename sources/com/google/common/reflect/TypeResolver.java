    ...
    public static void populateTypeMappings(Map<TypeVariableKey, Type> map, Type type, Type type2) {
        ...
        new TypeVisitor() { // from class: com.google.common.reflect.TypeResolver.1
            ...
            void visitTypeVariable(TypeVariable<?> typeVariable) {
                r1.put(new TypeVariableKey(typeVariable), r2);
            }
            ...
            void visitWildcardType(WildcardType wildcardType) {
                ...
                if (type3 instanceof WildcardType) {
                    ...
                    Preconditions.checkArgument(upperBounds.length == upperBounds2.length && lowerBounds.length == lowerBounds2.length, "Incompatible type: %s vs. %s", wildcardType, r2);
                    for (int i = 0; i < upperBounds.length; i++) {
                        TypeResolver.populateTypeMappings(r1, upperBounds[i], upperBounds2[i]);
                    }
                    for (int i2 = 0; i2 < lowerBounds.length; i2++) {
                        TypeResolver.populateTypeMappings(r1, lowerBounds[i2], lowerBounds2[i2]);
                    }
                }
            }
            ...
            void visitParameterizedType(ParameterizedType parameterizedType) {
                ...
                if (parameterizedType.getOwnerType() != null && parameterizedType2.getOwnerType() != null) {
                    TypeResolver.populateTypeMappings(r1, parameterizedType.getOwnerType(), parameterizedType2.getOwnerType());
                }
                Preconditions.checkArgument(parameterizedType.getRawType().equals(parameterizedType2.getRawType()), "Inconsistent raw type: %s vs. %s", parameterizedType, r2);
                ...
                for (int i = 0; i < actualTypeArguments.length; i++) {
                    TypeResolver.populateTypeMappings(r1, actualTypeArguments[i], actualTypeArguments2[i]);
                }
            }
            ...
            void visitGenericArrayType(GenericArrayType genericArrayType) {
                ...
                Preconditions.checkArgument(componentType != null, "%s is not an array type.", r2);
                TypeResolver.populateTypeMappings(r1, genericArrayType.getGenericComponentType(), componentType);
            }
    ...
    private static class TypeTable {
        ...
        class AnonymousClass1 extends TypeTable {
            ...
            public Type resolveInternal(TypeVariable<?> typeVariable, TypeTable typeTable) {
                return typeVariable.getGenericDeclaration().equals(r2.getGenericDeclaration()) ? typeVariable : r3.resolveInternal(typeVariable, typeTable);
            }
        }
        ...
        final Type resolve(TypeVariable<?> typeVariable) {
            return resolveInternal(typeVariable, new TypeTable(this) { // from class: com.google.common.reflect.TypeResolver.TypeTable.1
                ...
                public Type resolveInternal(TypeVariable<?> typeVariable2, TypeTable typeTable) {
                    return typeVariable2.getGenericDeclaration().equals(r2.getGenericDeclaration()) ? typeVariable2 : r3.resolveInternal(typeVariable2, typeTable);
                }
            });
        }
    ...
    private static class WildcardCapturer {
        ...
        class AnonymousClass1 extends WildcardCapturer {
            ...
            TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
                ...
                linkedHashSet.addAll(Arrays.asList(r3.getBounds()));

...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    FirebaseInstallations(FirebaseApp firebaseApp, Provider<HeartBeatController> provider, ExecutorService executorService, Executor executor) {
        this(executorService, executor, firebaseApp, new FirebaseInstallationServiceClient(firebaseApp.getApplicationContext(), provider), new PersistedInstallation(firebaseApp), Utils.getInstance(), new Lazy((Provider) new Provider() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda0
            public /* synthetic */ FirebaseInstallations$$ExternalSyntheticLambda0() {
            }
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda2
            public /* synthetic */ FirebaseInstallations$$ExternalSyntheticLambda2() {
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m110xc18eb11d();
            }
        });
    ...
    public Task<InstallationTokenResult> getToken(boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda4
            ...
            public /* synthetic */ FirebaseInstallations$$ExternalSyntheticLambda4(boolean z2) {
                r2 = z2;
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m111x7147f7aa(r2);
            }
        });
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda3
            public /* synthetic */ FirebaseInstallations$$ExternalSyntheticLambda3() {
            }
    ...
    public final void m111x7147f7aa(boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda1
            ...
            public /* synthetic */ FirebaseInstallations$$ExternalSyntheticLambda1(boolean z2) {
                r2 = z2;
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m109x5a306a82(r2);
            }
        });
    }
    ...
    */
    public void m109x5a306a82(boolean r3) {
        /*
            r2 = this;
        ...
        L5f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m109x5a306a82(boolean):void");
    }

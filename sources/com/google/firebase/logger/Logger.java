...
public abstract class Logger {
    ...
    public static final class FakeLogger extends Logger {
        ...
        private final String toLogMessage(Level level, String format, Object[] args, Throwable throwable) {
            ...
            if (throwable != null) {
                String str = level + SpanChipTokenizer.AUTOCORRECT_SEPARATOR + format + SpanChipTokenizer.AUTOCORRECT_SEPARATOR + Log.getStackTraceString(throwable);
                if (str != null) {
                    return str;
                }
            }
            return level + SpanChipTokenizer.AUTOCORRECT_SEPARATOR + format;
        }
    }

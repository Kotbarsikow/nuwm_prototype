...
public class ServiceStarter {
    ...
    private synchronized String resolveServiceClassName(Context context, Intent intent) {
        ...
        if (resolveService != null && resolveService.serviceInfo != null) {
            ...
            Log.e(Constants.TAG, "Error resolving target intent service, skipping classname enforcement. Resolved service was: " + serviceInfo.packageName + URIUtil.SLASH + serviceInfo.name);
            return null;
        }

...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
                public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda3() {
                }

                @Override // com.google.firebase.iid.internal.FirebaseInstanceIdInternal.NewTokenListener
                public final void onNewToken(String str) {
                    FirebaseMessaging.this.m121lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda4() {
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m122lambda$new$2$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        createInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda5() {
            }

            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.this.m123lambda$new$3$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda6() {
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m124lambda$new$4$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* renamed from: lambda$new$2$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m122lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    /* synthetic */ void m123lambda$new$3$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public void m124lambda$new$4$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda12
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda12() {
            }

            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.this.m120x8ede5a30((CloudMessage) obj);
            }
        });
    }

    /* renamed from: lambda$handleProxiedNotificationData$5$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m120x8ede5a30(CloudMessage cloudMessage) {
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z).addOnSuccessListener(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda10() {
            }

            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                FirebaseMessaging.this.m125x6495830d((Void) obj);
            }
        });
    }

    /* renamed from: lambda$setNotificationDelegationEnabled$6$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m125x6495830d(Void r3) {
        ProxyNotificationPreferences.setProxyRetention(this.context, this.gmsRpc, shouldRetainProxyNotifications());
    }
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda11
            ...
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda11(TaskCompletionSource taskCompletionSource2) {
                r2 = taskCompletionSource2;
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m119x6a533e85(r2);
            }
        });
        return taskCompletionSource2.getTask();
    }

    /* renamed from: lambda$getToken$7$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m119x6a533e85(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
                ...
                public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda1(TaskCompletionSource taskCompletionSource2) {
                    r2 = taskCompletionSource2;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    FirebaseMessaging.this.m117xd5738b77(r2);
                }
            });
            return taskCompletionSource2.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
            ...
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda2(TaskCompletionSource taskCompletionSource22) {
                r2 = taskCompletionSource22;
            }

            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m118xd4fd2578(r2);
            }
        });
        return taskCompletionSource22.getTask();
    }

    /* renamed from: lambda$deleteToken$8$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m117xd5738b77(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    /* renamed from: lambda$deleteToken$9$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ void m118xd4fd2578(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> subscribeToTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda0
            ...
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda0(String str2) {
                r1 = str2;
            }
            ...
            public final Task then(Object obj) {
                ...
                subscribeToTopic = ((TopicsSubscriber) obj).subscribeToTopic(r1);
    ...
    public Task<Void> unsubscribeFromTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda13
            ...
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda13(String str2) {
                r1 = str2;
            }
            ...
            public final Task then(Object obj) {
                ...
                unsubscribeFromTopic = ((TopicsSubscriber) obj).unsubscribeFromTopic(r1);
    ...
    String blockingGetToken() throws IOException {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda14
                ...
                public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda14(String defaultSenderId2, Store.Token tokenWithoutTriggeringSync2) {
                    r2 = defaultSenderId2;
                    r3 = tokenWithoutTriggeringSync2;
                }

                @Override // com.google.firebase.messaging.RequestDeduplicator.GetTokenRequest
                public final Task start() {
                    return FirebaseMessaging.this.m116xb7d2b1c4(r2, r3);
                }
            }));
    ...
    /* renamed from: lambda$blockingGetToken$14$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ Task m116xb7d2b1c4(String str, Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda9
            ...
            public /* synthetic */ FirebaseMessaging$$ExternalSyntheticLambda9(String str2, Store.Token token2) {
                r2 = str2;
                r3 = token2;
            }
            ...
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return FirebaseMessaging.this.m115xb84917c3(r2, r3, (String) obj);
            }
        });
    }

    /* renamed from: lambda$blockingGetToken$13$com-google-firebase-messaging-FirebaseMessaging */
    /* synthetic */ Task m115xb84917c3(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m121lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m121lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    class AutoInit {
        ...
        synchronized void initialize() {
            ...
            if (readEnabled == null) {
                FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0 firebaseMessaging$AutoInit$$ExternalSyntheticLambda0 = new EventHandler() { // from class: com.google.firebase.messaging.FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0
                    public /* synthetic */ FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0() {
                    }

                    @Override // com.google.firebase.events.EventHandler
                    public final void handle(Event event) {
                        FirebaseMessaging.AutoInit.this.m126x1061f0b8(event);
                    }
                };
        ...
        /* synthetic */ void m126x1061f0b8(Event event) {
            if (isEnabled()) {

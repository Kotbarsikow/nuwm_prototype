...
public final class SplitPairFilter {
    ...
    public SplitPairFilter(ComponentName primaryActivityName, ComponentName secondaryActivityName, String str) {
        ...
        if (StringsKt.contains$default((CharSequence) str2, (CharSequence) Constraint.ANY_ROLE, false, 2, (Object) null) && StringsKt.indexOf$default((CharSequence) str2, Constraint.ANY_ROLE, 0, false, 6, (Object) null) != packageName.length() - 1) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
        }
        if (StringsKt.contains$default((CharSequence) str3, (CharSequence) Constraint.ANY_ROLE, false, 2, (Object) null)) {
            obj = null;
            if (StringsKt.indexOf$default((CharSequence) str3, Constraint.ANY_ROLE, 0, false, 6, (Object) null) != className.length() - 1) {
        ...
        if (StringsKt.contains$default((CharSequence) str4, (CharSequence) Constraint.ANY_ROLE, false, 2, obj) && StringsKt.indexOf$default((CharSequence) str4, Constraint.ANY_ROLE, 0, false, 6, (Object) null) != packageName2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in package name is only allowed at the end.".toString());
        }
        String str5 = className2;
        if (StringsKt.contains$default((CharSequence) str5, (CharSequence) Constraint.ANY_ROLE, false, 2, obj) && StringsKt.indexOf$default((CharSequence) str5, Constraint.ANY_ROLE, 0, false, 6, (Object) null) != className2.length() - 1) {
            throw new IllegalArgumentException("Wildcard in class name is only allowed at the end.".toString());
        }
    }

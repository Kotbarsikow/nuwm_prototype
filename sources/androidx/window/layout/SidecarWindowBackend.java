    ...
    public static final class WindowLayoutChangeCallbackWrapper {
        ...
        public final void accept(WindowLayoutInfo newLayoutInfo) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.layout.SidecarWindowBackend$WindowLayoutChangeCallbackWrapper$$ExternalSyntheticLambda0
                ...
                public /* synthetic */ SidecarWindowBackend$WindowLayoutChangeCallbackWrapper$$ExternalSyntheticLambda0(WindowLayoutInfo newLayoutInfo2) {
                    r2 = newLayoutInfo2;
                }

                @Override // java.lang.Runnable
                public final void run() {
                    SidecarWindowBackend.WindowLayoutChangeCallbackWrapper.m51accept$lambda0(SidecarWindowBackend.WindowLayoutChangeCallbackWrapper.this, r2);
                }
            });
        }

        /* renamed from: accept$lambda-0 */
        public static final void m51accept$lambda0(WindowLayoutChangeCallbackWrapper this$0, WindowLayoutInfo newLayoutInfo) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            Intrinsics.checkNotNullParameter(newLayoutInfo, "$newLayoutInfo");

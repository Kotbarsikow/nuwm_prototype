...
public final class WindowMetricsCalculatorCompat implements WindowMetricsCalculator {
    ...
    public final Point getRealSizeForDisplay$window_release(Display r3) {
        Intrinsics.checkNotNullParameter(r3, "display");
        Point point = new Point();
        DisplayCompatHelperApi17.INSTANCE.getRealSize(r3, point);
        return point;
    }
    ...
    private final DisplayCutout getCutoutForDisplay(Display r9) {
        try {
            Constructor<?> constructor = Class.forName("android.view.DisplayInfo").getConstructor(null);
            constructor.setAccessible(true);
            Object newInstance = constructor.newInstance(null);
            Method declaredMethod = r9.getClass().getDeclaredMethod("getDisplayInfo", newInstance.getClass());
            declaredMethod.setAccessible(true);
            declaredMethod.invoke(r9, newInstance);

...
public final class ExtensionWindowLayoutInfoBackend implements WindowBackend {
    ...
    private static final class MulticastConsumer implements java.util.function.Consumer<androidx.window.extensions.layout.WindowLayoutInfo> {
        ...
        public /* synthetic */ java.util.function.Consumer<androidx.window.extensions.layout.WindowLayoutInfo> andThen(java.util.function.Consumer<? super androidx.window.extensions.layout.WindowLayoutInfo> consumer) {
        ...
        public final void addListener(Consumer<WindowLayoutInfo> r3) {
            ...
            try {
                ...
                if (windowLayoutInfo != null) {
                    r3.accept(windowLayoutInfo);
                }
                this.registeredListeners.add(r3);
            } finally {
                reentrantLock.unlock();
            }
        }

        public final void removeListener(Consumer<WindowLayoutInfo> r3) {
            Intrinsics.checkNotNullParameter(r3, "listener");
            ReentrantLock reentrantLock = this.multicastConsumerLock;
            reentrantLock.lock();
            try {
                this.registeredListeners.remove(r3);
            } finally {
                reentrantLock.unlock();
            }
        }

...
public class KeyFrames {
    ...
    static {
        ...
        try {
            ...
            sKeyMakers.put(TypedValues.Position.NAME, KeyPosition.class.getConstructor(null));
            sKeyMakers.put(TypedValues.Cycle.NAME, KeyCycle.class.getConstructor(null));
            sKeyMakers.put("KeyTimeCycle", KeyTimeCycle.class.getConstructor(null));
            sKeyMakers.put(TypedValues.Trigger.NAME, KeyTrigger.class.getConstructor(null));

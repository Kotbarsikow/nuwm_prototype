...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            boolean z = ((double) staggered) < Utils.DOUBLE_EPSILON;
    ...
    */
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            String concat = MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR.concat(params.startToStart != -1 ? "SS" : "__");
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            String str = title + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Debug.getName((View) c.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str2 + "  " + name + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + constraintWidget + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + sb6);
            }

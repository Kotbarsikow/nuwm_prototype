...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (findPreviousPosition != null) {
                int i23 = (int) (findPreviousPosition.x * i);
                i10 = i16;
                i9 = i2;
                int i24 = (int) (findPreviousPosition.y * i9);
            ...
            if (findNextPosition != null) {
                int i25 = (int) (findNextPosition.x * i);
                int i26 = (int) (findNextPosition.y * i9);
        ...
        int i27 = (int) (i7 + ((i8 - i7) * f5));
        widgetFrame.left = i27;
        int i28 = (int) (i6 + (f5 * (i17 - i6)));
        widgetFrame.top = i28;
        float f10 = 1.0f - f;
        widgetFrame.right = i27 + ((int) ((i3 * f10) + (i20 * f)));
        widgetFrame.bottom = i28 + ((int) ((f10 * i4) + (i21 * f)));
    ...
    void printCustomAttributes() {
        ...
        String str = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + (hashCode() % 1000);
        String str2 = this.widget != null ? str + URIUtil.SLASH + (this.widget.hashCode() % 1000) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : str + "/NULL ";
    ...
    void logv(String str) {
        String str2;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str3 = (".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName()) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + (hashCode() % 1000);
        if (this.widget != null) {
            str2 = str3 + URIUtil.SLASH + (this.widget.hashCode() % 1000);
        } else {
            str2 = str3 + "/NULL";
        }
        System.out.println(str2 + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + str);
    }
}
